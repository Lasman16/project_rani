                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                ...
                                <a class="dropdown-item" href="/PengajuanSuratKeteranganGhaib">Surat Keterangan
                                    Ghaib</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="/PengajuanSuratKeteranganDomisiliTempatTinggal">Surat
                                    Keterangan Domisili Tempat Tinggal</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="/PengajuanSuratKeteranganOrangYangSama">Surat Keterangan
                                    Orang Yang Sama</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="/PengajuanSuratKeteranganKelahiran">Surat Keterangan
                                    Kelahiran</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="/PengajuanSuratKeteranganKematian">Surat Keterangan
                                    Kematian</a>
                            </div>
                        </li>
        ...
        <div class="form">
            ...
            <form action="#">
                ...
                <div class="input-box" style="margin-bottom: 15px;">
                    <span class="details"
                        style="display: block; font-weight: 500; margin-bottom: 5px; padding-top: 20px;">Surat
                ...
                <div class="input-box" style="margin-bottom: 15px;">
                    <span class="details"
                        style="display: block; font-weight: 500; margin-bottom: 5px; padding-top: 20px;">Foto KTP
                        Pemilik Usaha</span>
                    <div class="custom-file">
                ...
                <div class="input-box" style="margin-bottom: 15px;">
                    <span class="details"
                        style="display: block; font-weight: 500; margin-bottom: 5px; padding-top: 20px;">Foto KK Pemilik
                        Usaha</span>
                    <div class="custom-file">
                ...
                <div class="input-box" style="margin-bottom: 15px;">
                    <span class="details"
                        style="display: block; font-weight: 500; margin-bottom: 5px; padding-top: 20px;">Foto
                        Usaha</span>
                    <div class="custom-file">
